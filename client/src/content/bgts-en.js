export default {
  ...
  description:
    "The Beginners Global Taiko Showdown, our 2v2 tournament for beginners players, being restricted for ranks #8,000 to no bottom rank limit. The top 16 teams after qualifiers will then face off in a Group Stage, where 8 teams will go through, and play in a double-elimination bracket.",
  discord: "https://discord.gg/3mGC3HB",
  homepage: [
    {
      title: "Restrictions",
      body: `This tournament is open for players rank #8,000 to no bottom rank limit. Any osu!taiko player in this rank range who has not been restricted within the past 12 months will be allowed in this tournament. The osu! support reserves the right from removing any player from the tournament following the screening phase. The Player Moderation Team also reserves the right from removing any player from the tournament at any point during it.`,
    },
    {
      title: "Dates",
      body: `
### Registration Phase
November 8th until November 22nd.
 ### Screening phase
November 22nd until November 29th.
### Qualifiers
...
- **1st place:** osu! profile badge (to be confirmed), 6 months of supporter per player, along with a customized mousepad by Foxbox.
 ...
 # Match Regulations
  ...
  - The match will be played as TeamVs and ScoreV2 and the name of the room must be: "BGTS 2020: (Team Red) vs (Team Blue)". 
  - Each team is allowed one warm-up but it must be below 3 minutes, and must be sent to the streamer of the match if applicable at most one hour before the match begins. Everyone is allowed in the room during warm ups. 
