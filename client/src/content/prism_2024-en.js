export default {
  name: "Project Prism",
  description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi orci dui, molestie mattis erat sed, semper vulputate diam. Donec a vestibulum mauris. ",
  links: [
    {
      label: "Discord",
      link: "https://discord.gg/osutaikomy"
    },
    {
      label: "Challonge",
    ...
    {
      label: "Pick'ems",
      link: "https://pickem.hwc.hr/tournaments/144"
    },
  ],
  homepage: [
    {
      title: "Restrictions",
      body: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi orci dui, molestie mattis erat sed, semper vulputate diam. Donec a vestibulum mauris. Duis eu justo eu eros gravida venenatis vitae in lorem. Curabitur sollicitudin, purus at cursus sagittis, libero lectus sagittis mauris, sed suscipit leo quam ac augue.`,
    },
    {
      title: "Dates",
      body: `
...
- Any members of staff apart from **Organizers, Head Mappoolers, Mappers and Referees** are allowed to play.
