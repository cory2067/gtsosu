export default {
  name: "Beginner's Taiko Tournament Season 8",
  description:
  ...
  links: [
    ...
    {
      label: "Challonge",
      link: "https://challonge.com/BTTS8"
    },
  ],
  homepage: [
    {
...
There are no other prizes being considered for BTT8
`,
    },
  ],
  rules: `
...
- The match will be played with HeadToHead and ScoreV2. The name of the lobby must be: "BTT8: (Red Player) vs (Blue Player)
