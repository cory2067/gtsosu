export default {
  ...
  homepage: [
    {
      title: "Restrictions",
      body: `This tournament is open for players rank #1,500 to #4,500. Any osu!taiko player in this rank range who has not been restricted within the past 12 months will be allowed in this tournament. The osu! support reserves the right from removing any player from the tournament following the screening phase.`,
    },
    {
      title: "Dates",
      body: `
### Registration Phase
October 10th until October 23rd.
### Screening phase
October 23rd until October 30th.
### Qualifiers
November 5th until November 6th.
### Group Stage
November 12th until November 13th.
### Round of 16
November 19th until November 20th.
### Quarterfinals + Loser's Bracket Round 1
November 26th until November 27th.
### Semifinals + Loser's Bracket Round 2 and 3
December 3rd until December 4th.
### Winner's Bracket Finals and Loser's Bracket Round 4 and 5
December 10th until December 11th.
### Grand Finals + Loser's Bracket Grand Finals + All-Stars
December 17th until December 18th.`,
...
# Tournament Registration and Teams Creation
 - In order to participate you need to be in the rank range of #1500 to #4500.
 - After registrations close, you are allowed to rank up until #1300. If you pass this limit at any point during the rest of the tourney, you will be disqualified.
...
# Stage Regulations
 ...
 - Teams will be drawn in **8 groups of 4 teams** during a drawing show which will happen on Sunday November 6th 18:00UTC. 
 ...
 - The winning condition for each stage is:
   ...
   - RO16, Quarterfinals and Loser's bracket round 1: BO11 (win 6 maps)
   - Semifinals, Finals, Grand Finals and Loser's Bracket Round 2, 3, 4 and 5: BO13 (win 7 maps)
...
# Match Regulations
 ...
 - The match will be played as TeamVs and ScoreV2 and the name of the room must be: "RGTS 2022: (Team Red) vs (Team Blue)". 
 - Each team is allowed one warm-up but it must be below 3 minutes, and must be sent on the website up to one hour prior to the match's start time. Teams will be allowed to send warmups starting from the day schedules release. Otherwise, the team will have no warmups.
...
# Mappool Instructions
 ...
 - The Qualifiers pool will be different from all the other rounds as it will have a format of 3 NoMod maps, 2 Hidden maps, 2 Hard Rock map, 1 Double Time map, and 1 FreeMod map. 
