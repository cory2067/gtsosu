export default {
  ...
  description:
    "The Intermediate Global Taiko Showdown, the founding tournament of this series. It's our 2v2 tournament for intermediate level players being restricted for ranks #3,500 to #10,000. The teams will first play in a qualifiers. The top 32 teams will then play in a Group Stage where 16 teams will go through and play in a double-elimination bracket.",
  links: [
    {
      label: "Discord",
    ...
    {
      label: "Challonge",
      link: "https://challonge.com/IGTS2021"
    },
    {
      label: "Pick'ems",
      link: "https://pickem.hwc.hr/tournaments/71"
    },
  ],
  homepage: [
    {
      title: "Restrictions",
      body: `1. You must be between ranks #3500  - #10000 in osu!taiko during the entirety of the registration phase.
2. You are not allowed to rank up further than #2500 during the tournament. If you pass this limit you'll be disqualified. 
3. You must join the Discord server of the tournament. 
4. Any osu!taiko player who has not been restricted within the past 12 months and follows these criterias will be allowed in this tournament. The osu! support reserves the right from removing any player from the tournament following the screening phase.`,
    },
    { 
      title: "Registration", 
...
**Joining the Discord is mandatory to play in this tournament, and you will be removed from the tournament if you don't do so.**`,
    }, 
    {
      ...
      body: `
### Registration Phase
June 26th until July 11th.
### Screening and teams creation
July 11th until July 18th.
### Qualifiers
...
September 4th until September 5th.`,
    },
    {
      title: "Prizes",
      body: `
...
- Teams will be drawn in **8 groups of 4 teams** during a drawing show which will happen on Sunday July 25th. 
