export default {
    ...
    links: [
      ...
      {
        label: "Pick'ems",
        link: "https://pickem.hwc.hr/tournaments/168"
      },
    ],
    homepage: [
      {
  ...
  4. You must not have been part of a team that has placed top 3 in the past 2 iterations or that has ever won AGTS.
  5. Any osu!taiko player who follows these criterias will be allowed in this tournament. The GTS team reserves the right of removing any player from the tournament during the registration and teams creation phase.`,
      },
      { 
        title: "Registration", 
  ...
  **Joining the Discord is mandatory to play in this tournament, and you will be removed from the tournament if you don't do so.**`,
  ...
  - The match will be played as TeamVs and ScoreV2 and the name of the room must be: "AGTS2025: (Team Red) vs (Team Blue)".
  ...
  - The Week 1 mappool will consist of 14 maps. Week 2 and Week 3 mappool will consist of 15 maps. Week 4, Week 5 and Week 6 mappool will consist of 16 maps.
  - The size of the Hidden, HardRock and DoubleTime brackets will be 2 in all stages
  - The size of the FreeMod bracket will be 2 in Week 1, 2 and 3; then 3 for Week 4, 5 and 6.
  - The size of the NoMod bracket will be 5 in Week 1 and 6 for all the other weeks.
