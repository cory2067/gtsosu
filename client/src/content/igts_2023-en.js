export default {
  ...
  4. You must not have been part of a team that has won IGTS or that has placed top 3 in the past 2 years.
  ...
  **Joining the Discord is mandatory to play in this tournament, and you will be removed from the tournament if you don't do so.**`,
  ...
  May 27th until May 28th.`,
      },
      {
        title: "Prizes",
        body: `
  - **1st place:** osu! profile badge & First place team banner
  ...
  - **Group Stage**
    ...
    - The top 2 teams of each group will join the teams seeded 9-16 in the Runoff Bracket.
  - **Runoff Bracket**
    - The Runoff Bracket is an intermediate bracket in which teams will compete to have a chance to play in the main bracket.
    - The Winner Bracket will see the teams seeded 9-16 play against each other (9 will play against 16 and so on).
  ...
  - **Main Bracket**
    ...
    - The matchups will follow the Runoff Bracket match IDs in reverse order (for example: ID 1 corresponds to seed 9 vs seed 16, winner of this match will play against seed 8)
