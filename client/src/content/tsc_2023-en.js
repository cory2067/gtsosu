export default {
  ...
  description:
    "The Taiko Suiji Cup 2023, one of the biggest osu!taiko tournaments. 4v4, no rank limit, and entirely random teams. The top 32 teams after the seeding phase will play in a double-elimination bracket.",
  discord: "https://discord.gg/yV3bDTC",
  homepage: [
    {
      title: "Restrictions",
      body: `This tournament is open for any osu!taiko player. Any osu!taiko player who has not been restricted within the past 12 months will be allowed in this tournament. The osu! support reserves the right from removing any player from the tournament following the screening phase.`,
    },
    {
      title: "Dates",
      body: `
...
# Tournament Registration and Teams Creation
 - Players sign up individually. When their registration is accepted, they will get a player role. 
 - Teams will have to decide on their captain and team logo whenever their team has been finalized.
...
# Match Regulations
 ...
 - The team with the highest roll **gets first warmup, first ban and first pick**.
...
# Mappool Instructions
 - There will be 1 mappool for each of the following: Qualifiers, RO32, RO16, Quarterfinals, Semifinals, Finals and Grand Finals.
