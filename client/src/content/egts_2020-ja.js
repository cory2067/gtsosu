...
7月25日～7月26日`,
    ...
    { title: "登録方法", body: "osu!のアカウントでログインした後、上にあるRegisterボタンを押してください。その後Discordの大会サーバーに上のボタンを押して参加してください。**大会に出場する場合Discordサーバーへの参加は必須です。もし参加しなかった場合は大会への出場が取り消しとなります。**" }, 
    {
      title: "賞品",
      body: `
- **優勝：**osu! プロフィールバッジ（手続き中）、$66（約71103相当）もしくは1年分のosu!サポーター、 GTSオリジナルのマウスパッド（提供：[Foxbox](https://foxbox.io)）
- **準優勝：**$36（約3878円相当）もしくは6か月分のosu!$2ポーター、 GTSオリジナルのマウスパッド（提供：[Foxbox](https://foxbox.io)）
- **3位：**$28（約3000円相当）もしくは2か月分のosu!サポーター、 GTSオリジナルのマウスパッド（提供：[Foxbox](https://foxbox.io)）`,
    },
  ],
  rules: `
# 基本ルール
